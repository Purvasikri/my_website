...
description: Nullam et orci eu lorem consequat tincidunt vivamus et sagittis magna
  ...
  consequat tincidut. Vivamus et sagittis tempus.
draft: false
image: RTI.jpg
keywords: ""
slug: purva
...
> 2. The continents that had high average life expectancy in 1950's (Ocenia and Europe), experiences low growth rate in the average life expectancy in the coming years. Whereas, Asia's life expectatncy has shown a significant growth in teh above-mentioned years.
...
> 4. Although  intuitive, some of the reasons for a higher life expectancy in Europe, Oceania, and America are their high standards of healthcare, standards of living (access to healthier food), and hygiene. Further, their lower populations also increase the acess to quality healthcare.
...
> 3. The moderate relationship can be because some people feared wether 'UK should have the power to govern and manage itself' while the others believed that 'EU's more open border policy could do more harm than good to UK'.
...
Converting the `incident_notional_cost` from `chr` to numeric
...
> imp: Observations about the mean, median, and outliers of the cost to rescue each animal group:
>
...
Making a hisogram, density plot, boxplot, and empirical cumulative distribution function to make inferences about the districution of incidents per animal category.
...
> From these observations, it can be infered that the **size/weight** of the animal is positively correlated with the cost of rescuing (i.e. the heavier or bigger the animal the more time it takes to be resuced incurring higher costs). Further, another consideration could be that the more dangerous the animal the more time consuming it is to rescue, in turn incurring high costs (snakes are more expensive to rescue but are smaller than dogs - could be that a snake's rescuing may require more protective equipments increasing the average time and costs). It is also noteworthy to mention that the count of cats, dogs, and birds being rescued is the highest (may be due to in house incidents with pets).
>
