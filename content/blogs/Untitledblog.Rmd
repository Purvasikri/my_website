...
### Hobbies
    ...
    2. Swimming (Represented my city in state competitions).
    3. Bridal jewelery designing
    
**Few of my bridal designs are:**

```{r, echo = F, out.width="50%"}
knitr::include_graphics("/img/blogs/jd1.jpg", error = FALSE)
```

```{r, echo = F, out.width="50%"}
knitr::include_graphics("/img/blogs/jd2.jpg", error = FALSE)
```
